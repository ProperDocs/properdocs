    ...
    <div class="card mb-4">
      <div class="card-body">
        ...
        <p class="card-text">
            ...
            (on the <a href="https://github.com/mkdocs/mkdocs/wiki/ProperDocs-Themes">ProperDocs Themes</a> wiki page
            as well as the <a href="https://github.com/mkdocs/catalog#-theming">ProperDocs Catalog</a>),
